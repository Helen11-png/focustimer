...
export default function SettingsScreen() {
  ...
  return (
    ...
    >
      ...
      {/* Тема */}
      <ThemedView style={[styles.section, { backgroundColor: scheme.surface }]}>
        ...
        {useSystemTheme && (
          <ThemedView style={[styles.hint, { backgroundColor: `${scheme.primary}10` }]}>
      ...
      <ThemedView style={[styles.section, { backgroundColor: scheme.surface }]}>
        ...
        <ThemedView style={styles.colorSchemes}>
          {colorSchemes.map((colorScheme) => (
            ...
            >
              ...
              />
              <ThemedView style={styles.colorSchemeInfo}>
                <ThemedText style={[styles.colorSchemeName, { color: scheme.text }]}>
                  {colorScheme.name}
                </ThemedText>
                <ThemedView style={styles.colorDots}>
              ...
              {currentScheme === colorScheme.id && (
                <ThemedView style={[styles.checkmark, { backgroundColor: colorScheme.primary }]}>
      ...
      <ThemedView style={[styles.section, { backgroundColor: scheme.surface }]}>
        ...
        {customColors.length > 0 && (
          <ThemedView style={styles.customColorsList}>
            {customColors.map((color) => (
              <ThemedView key={color.id} style={styles.customColorItem}>
                <ThemedView style={styles.customColorInfo}>
                  <ThemedView
                ...
                <ThemedView style={styles.customColorActions}>
                  <TouchableOpacity
      ...
      <ThemedView style={[styles.section, { backgroundColor: scheme.surface }]}>
        ...
        <ThemedView style={styles.previewContainer}>
          <ThemedView style={styles.previewRow}>
            <ThemedView style={[styles.previewItem, { backgroundColor: scheme.primary }]}>
              <ThemedText style={styles.previewText}>Primary</ThemedText>
            </ThemedView>
            <ThemedView style={[styles.previewItem, { backgroundColor: scheme.secondary }]}>
              <ThemedText style={styles.previewText}>Secondary</ThemedText>
            </ThemedView>
            <ThemedView style={[styles.previewItem, { backgroundColor: scheme.accent }]}>
              <ThemedText style={styles.previewText}>Accent</ThemedText>
            </ThemedView>
          </ThemedView>

          <ThemedView style={styles.previewRow}>
            <ThemedView style={[styles.previewItem, { backgroundColor: scheme.success }]}>
              <ThemedText style={styles.previewText}>Success</ThemedText>
            </ThemedView>
            <ThemedView style={[styles.previewItem, { backgroundColor: scheme.warning }]}>
              <ThemedText style={styles.previewText}>Warning</ThemedText>
            </ThemedView>
            <ThemedView style={[styles.previewItem, { backgroundColor: scheme.error }]}>
              <ThemedText style={styles.previewText}>Error</ThemedText>
            </ThemedView>
          </ThemedView>

          <ThemedView style={[styles.previewCard, { backgroundColor: scheme.surface, borderColor: scheme.border }]}>
      ...
      >
        <ThemedView style={styles.modalOverlay}>
          <ThemedView style={[styles.modalContent, { backgroundColor: scheme.surface }]}>
            ...
            <ThemedView style={styles.modalBody}>
              ...
              <ThemedView style={styles.modalField}>
                ...
                <ThemedView style={styles.colorPickerRow}>
                  <TextInput
                    style={[
                      styles.modalInput,
              ...
              <ThemedView style={styles.presetColors}>
                <ThemedText style={[styles.presetColorsTitle, { color: scheme.textSecondary }]}>
                  Preset Colors
                </ThemedText>
                <ThemedView style={styles.presetColorsGrid}>
